...
include('/var/www/html/public/excel/vendor/autoload.php');

class GoogleClient
{
 protected $client_id = '1016165829239-ndo0vg766jenqnp629rv0o5ufngtgn8s.apps.googleusercontent.com';
    protected $client_secret = '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';
    protected $redirect_uri = 'https://varilytics.com/admin/get_work';
    ...
    {   
        ...
        if (isset($_SESSION['GOOGLE_ACCESS_TOKEN'])) {
            echo $_SESSION['GOOGLE_ACCESS_TOKEN'];die;
            return true;
        } else {
            return false;
        }
