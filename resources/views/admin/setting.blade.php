                ...
                <div class="card-body container">
                        <form id="save_setting" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <input type="text" class="form-control" name="address" value="{{$userDetail[0]->address}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <input type="text" class="form-control" name="pan_no" value="{{$userDetail[0]->pan_no}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <input type="text" class="form-control" name="account_no" value="{{$userDetail[0]->account_no}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
