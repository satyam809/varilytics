...
<body>
    ...
    <div id="main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand" href="index"> <img src="assets/images/logo.jpeg" alt="" class="img-fluid" style="width: 80px;"> </a>
                                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    <ul class="navbar-nav">
                                        <!-- <li class="nav-item"> <a class="nav-link" href="about">About Us</a>
                                        </li> -->
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="statistics">Statistics </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="agriculture">Agriculture </a> <a class="dropdown-item" href="art_design">Art and Design</a> <a class="dropdown-item" href="education">Education </a> <a class="dropdown-item" href="finance">Finance </a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="insights">Insights </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="infographics">Infographics </a> <a class="dropdown-item" href="visuals">Visuals </a> <a class="dropdown-item" href="analytics">Analytics</a> <a class="dropdown-item" href="dashboards">Dashboards </a> <a class="dropdown-item" href="on-demand-services">On Demand Services </a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="data_atlas">Data Atlas </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="data-board">Data Board </a> <a class="dropdown-item" href="data-coverage">Data Coverage </a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">Tools </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="simple-search">Search</a> <a class="dropdown-item" href="custom-query">Query</a> <a class="dropdown-item" href="compare_sources">Compare</a> <a class="dropdown-item" href="create">Create</a> <a class="dropdown-item" href="publish">Publish</a>
                                            </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="data_store">Data Store </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="dashboard">Dashboard</a> <a class="dropdown-item" href="infographics">Infographics</a> <a class="dropdown-item" href="outlooks">Outlooks</a> <a class="dropdown-item" href="publications">Publications</a> <a class="dropdown-item" href="reports">Reports</a> <a class="dropdown-item" href="statistics">Statistics</a> <a class="dropdown-item" href="surveys">Surveys</a> <a class="dropdown-item" href="varisurvey">VariSurvey</a> <a class="dropdown-item" href="data_visuals">Visuals</a> <a class="dropdown-item" href="whitepapers">Whitepapers</a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="resources">Resources </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item disabled" href="compendiums">Compendiums</a> <a class="dropdown-item disabled" href="repositories">Repositories</a> <a class="dropdown-item disabled" href="intelligence-system">Intelligence System</a> <a class="dropdown-item" href="newsfeed">Newsfeed</a> <a class="dropdown-item" href="blogs">Blogs</a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="subscription">Pricing & Access </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="registration">Registration</a> <a class="dropdown-item" href="purchase">Purchase</a>
                                                <ul>
                                                    <li class="dropdown-toggle2"> <a class="dropdown-item" href="subscription" data-toggle="dropdown">Subscription
                                                        </a>
                                                        <div class="dropdown-menu2"> <a class="dropdown-item" href="basic_access">Basic Access</a>
                                                            <a class="dropdown-item" href="professional_access">Professional Access</a>
                                                            <a class="dropdown-item" href="insights_access">Insight
                                                                Access</a> <a class="dropdown-item" href="premium_access">Premium Access</a>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="signin-btn"> <a class="btn btn-primary" href="login">Login</a> </div>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <div class="data-times white-bg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col" data-aos="fade-up" data-aos-delay="600">
                        <p class="font-20">Agriculture statistics tell us the facts and figures. They will help set your action and directions.</p>
                    </div>
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="600"> <img src="assets/images/agriculture.jpeg" class="w-100 mb-3 float-right"> </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="font-20">Find India-centric agriculture related data at one place. We also cover other countries that are related to India economically or socially in context to Agriculture.</p>
                        <p class="font-20">Varilytics brings curated, collated, processed, and analyzed statistics for you</p>
                        <p class="font-20">We also provide customized solutions for primary data collection for insightful statistics</p>
                        <p class="font-20">Our tools allow you to visualize statistics with your own data sets through compare tools. You can upload your estimates and see them plotted with the database statistics</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="viewPage section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 pr-0">
                        ...
                        <div class="card" data-aos="fade-right" data-aos-delay="100" style="width:100%">
                            ...
                            <article class="filter-group">
                                <header class="card-header"> <a href="#" data-toggle="collapse" data-target="#freqentlysidecat" data-abc="true" aria-expanded="false" class="collapsed"> <i class="icon-control fa fa-chevron-down"></i>
                                        <h6 class="title">Frequency </h6>
                                    </a> </header>
                                <div class="filter-content collapse" id="freqentlysidecat" style="">
                                    <div class="card-body">
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Weekly Series (3) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Fortnightly Series (5) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Monthly Series (7) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Quarterly Series (3) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Bi-Annual Series (5) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Annual Series (7) </span> </label>
                                    </div>
                                </div>
                            </article>
                            <article class="filter-group">
                                <header class="card-header"> <a href="#" data-toggle="collapse" data-target="#timeseriessidecat" data-abc="true" aria-expanded="false" class="collapsed"> <i class="icon-control fa fa-chevron-down"></i>
                                        <h6 class="title">Time Series </h6>
                                    </a> </header>
                                <div class="filter-content collapse" id="timeseriessidecat" style="">
                                    <div class="card-body">
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Last 1 year (3) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Last 5 year (5) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Last 10 year (7) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">Last 20 year (3) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">2015-2020 (5) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">2005-2010 (7) </span> </label>
                                        <label class="checkbox-btn">
                                            <input type="checkbox">
                                            <span class="btn">2000-2005 (7) </span> </label>
                                    </div>
                                </div>
                            </article>
                            <article class="filter-group">
        ...
        <div class="browse_topicsmain section-padding">
            <div class="container">
                <div class="section-title text-center mb-0">
                    <h2>Browse Topics</h2>
                </div>
                <div class="browse-category"> <a href="#">
                        <div class="cat_box">
                            <div class="icon"> <img src="assets/images/icons/Agricultural-Area-Land-Use.svg"> </div>
        ...
        <div class="popular-statistics section-padding pt-2">
            <div class="container">
                <div class="section-title text-center mb-0">
                ...
                <div class="row monitoring mt-4">
                    ...
                    <div class="graph col-xs-12 col-md-6 mt-4">
                        <div class="chartPael">
                  ...
                  <input type="radio" name="mychart" class="mychart" id= "pie" value="pie" onclick= "chartfunc()">
                  <span class="checkmark"></span>
                </label> -->
                            </div>
                            <div id="container3" style="min-width: 200px; height: 287px; margin: 0 auto"></div>
                        </div>
                    </div>
                    <div class="graph col-xs-12 col-md-6 mt-4">
                        <div class="chartPael">
                            <div class="text-center">
                                <label class="radio-container">Line
                                    <input type="radio" class="mychart" id="line3a" checked value="line" onclick="chartfunc3a()" name="mychart3a">
                                    <span class="checkmark"></span> </label>
                                <label class="radio-container">Column
                                    <input type="radio" name="mychart3a" class="mychart" id="column3a" value="column" onclick="chartfunc3a()">
                                    <span class="checkmark"></span> </label>
                                <label class="radio-container">Bar
                                    <input type="radio" name="mychart3a" class="mychart" id="bar3a" value="bar" onclick="chartfunc3a()">
                                    <span class="checkmark"></span> </label>
                  ...
                  <span class="checkmark"></span>
                            ...
                            <div id="container3a" style="min-width: 200px; height: 290px; margin: 0 auto"></div>
                        </div>
                    </div>
                    <div class="graph col-xs-12 col-md-6 mt-4">
                        <div class="chartPael">
                            <div class="text-center">
                                <label class="radio-container">Bar
                                    <input type="radio" name="mychart3b" class="mychart" checked id="bar3b" value="bar" onclick="chartfunc3b()">
                                    <span class="checkmark"></span> </label>
                                <label class="radio-container">Column
                                    <input type="radio" name="mychart3b" class="mychart" id="column3b" value="column" onclick="chartfunc3b()">
                                    <span class="checkmark"></span> </label>
                                <label class="radio-container">Line
                                    <input type="radio" class="mychart" id="line3b" value="line" onclick="chartfunc3b()" name="mychart3b">
                                    <span class="checkmark"></span> </label>
                  ...
                  <span class="checkmark"></span>
                            ...
                            <div id="container3b" style="min-width: 200px; height: 290px; margin: 0 auto"></div>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="reportpage section-padding pt-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="row monitoring mt-4">
                                ...
                                <div class="graph col-xs-12 col-md-6 mt-4">
                                    <div class="chartPael">
                                        <div class="text-center">
                                            <label class="radio-container">Line
                                                <input type="radio" class="mychart" id="line4a" value="line" onclick="chartfunc4a()" checked name="mychart4a">
                                                <span class="checkmark"></span> </label>
                                            <label class="radio-container">Column
                                                <input type="radio" name="mychart4a" class="mychart" id="column4a" value="column" onclick="chartfunc4a()">
                                                <span class="checkmark"></span> </label>
                                            <label class="radio-container">Bar
                                                <input type="radio" name="mychart4a" class="mychart" id="bar4a" value="bar" onclick="chartfunc4a()">
                                                <span class="checkmark"></span> </label>
                                        </div>
                                        <div id="popularstats4a" style="min-width: 200px; height: 313px; margin: 0 auto"></div>
                                    </div>
                                </div>
                                <div class="graph col-xs-12 col-md-6 mt-4">
                                    <div class="chartPael">
                                        <div class="text-center">
                                            <label class="radio-container">Line
                                                <input type="radio" class="mychart" id="line4b" value="line" onclick="chartfunc4b()" checked name="mychart4b">
                                                <span class="checkmark"></span> </label>
                                            <label class="radio-container">Column
                                                <input type="radio" name="mychart4b" class="mychart" id="column4b" value="column" onclick="chartfunc4b()">
                                                <span class="checkmark"></span> </label>
                                            <label class="radio-container">Bar
                                                <input type="radio" name="mychart4b" class="mychart" id="bar4b" value="bar" onclick="chartfunc4b()">
                                                <span class="checkmark"></span> </label>
                                        </div>
                                        <div id="popularstats4b" style="min-width: 200px; height: 313px; margin: 0 auto"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!--RequestDataArea-->
                        <div class="RequestDataArea pt-0" data-aos="fade-up" data-aos-delay="500">
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <ul>
                                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> We follow an open data policy. All Statistics provided has their source acknowledged and declared.</li>
                                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Statistics we source from public domains is provided free with auto charting tools.</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <ul>
                                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Access free basic statistics </li>
                                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> We Provided Data tools to extract and analyze the data. We also provide our own analysis on the open data to provide crisp relevant and insightful statistics.</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4 text-center"><a href="#" class="btn btn-primary">Register</a></div>
                                </div>
                                <hr>
                                <div class="row mt-4 mb-4 align-items-center">
                                    <div class="col-md-4 text-center"><a href="#" class="btn btn-primary">Subscribe</a></div>
                                    <div class="col-md-8 pl-0">
                                        <ul>
                                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Access Premium Statistics</li>
                                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Varilytics can provide customizations to our existing datasets or can build new statistics with variables as you may require. We can also work on your datasets to create insights out of them.</li>
                                        </ul>
                                    </div>
                                </div>
                                <hr>
                                <div class="row mt-4 align-items-center">
                                    <div class="col-md-8 pr-0">
                                        <ul>
                                            <li>Get a Customization Quote </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4 text-center"><a href="#" class="btn btn-primary">Contatc Us</a></div>
                                </div>
                            </div>
                        </div>
                        <!--./RequestDataArea-->
                        ...
                        <div class="mb-4 text-center" data-aos="fade-up" data-aos-delay="100">Still don’t see what you want <a href="#" class="btn btn-primary btn-red">Submit Data Request</a></div>
                        <div class="mb-0 text-center" data-aos="fade-up" data-aos-delay="100">We shall get back to you shortly getting the data you require</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <!--  <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="copyright">
                            <p>© All Copyrights Reserved by <a href="javascript:void(0)">Varilytics</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
