            ...
            <div class="col-xl-7 col-lg-7">
                <div class="hero-content aos-init aos-animate" data-aos="fade-right" data-aos-delay="500">
                    <h1><span class="text-danger">Get more</span><br>
                        from data</h1>
                    <p>Varilytics is a flat access open platform for industry and industry themed data, data analytics,
                        research, and market intelligence for industry users so that the curated, derived, compared, and
                        processed data can be used in decision making.</p>
                    <a href="simple-search.php" class="btn btn-primary">Start Search</a>
                </div>
            </div>
            <div class="col-xl-5 col-lg-5">
                <div class="hero-img aos-init aos-animate" data-aos="fade-left" data-aos-delay="900"> <img src="./assets/images/1.png" alt="" class="img-fluid"> </div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="row m-0">
                    <div class="col-md-4 col-xs-12 p-0 borLineArea aos-init" data-aos="fade-up" data-aos-delay="500">
                        <div class="why-section-box"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/data-store.html"> <img src="./assets/images/view.png">
                                <h3>View</h3>
                            </a> </div>
                    </div>
                    <div class="col-md-4 col-xs-12 p-0 borLineArea aos-init" data-aos="fade-up" data-aos-delay="300">
                        <div class="why-section-box"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/simple-search.html"> <img src="./assets/images/searching.png">
                                <h3>Search</h3>
                            </a> </div>
                    </div>
                    <div class="col-md-4 col-xs-12 p-0 borLineArea aos-init" data-aos="fade-up" data-aos-delay="500">
                        <div class="why-section-box"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/custom-query.html"> <img src="./assets/images/supply-chain.png">
                                <h3>Query</h3>
                            </a> </div>
                    </div>
                    <div class="col-md-4 col-xs-12 p-0 borLineArea aos-init" data-aos="fade-up" data-aos-delay="400">
                        <div class="why-section-box"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/compare-sources.html"> <img src="./assets/images/diagram.png">
                                <h3>Compare</h3>
                            </a> </div>
                    </div>
                    <div class="col-md-4 col-xs-12 p-0 borLineArea aos-init" data-aos="fade-up" data-aos-delay="500">
                        <div class="why-section-box"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/create.html">
                                <img src="./assets/images/setting.png">
                                <h3>Create</h3>
                            </a> </div>
                    </div>
                    <div class="col-md-4 col-xs-12 p-0 borLineArea aos-init" data-aos="fade-up" data-aos-delay="500">
                        <div class="why-section-box"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/publish.html">
    ...
    <div class="container">
        ...
        <div class="covid-world-widget">
            <div class="updated-time row">
                    ...
                    <div class="covid-widget-1">
                        ...
                        <div class="info">
                            ...
                            <ul class="infoImgArea">
                                <li> <a href="infographics.php"> <img src="./assets/images/infographic1.jpg"></a> </li>
                            ...
                            <div class="bottom-link"> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html">Explore <img src="./assets/images/arrow-blue.png"></a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-6 aos-init" data-aos="fade-up" data-aos-delay="200">
                    <div class="covid-widget-1">
                        <div class="icon"> <img src="./assets/images/diet.png" alt=""> </div>
                        <div class="info">
                            <h5>Art and Design </h5>
                            <ul class="infoImgArea">
                                <li> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html"><img src="./assets/images/infographic2.jpg"></a> </li>
                                <div class="info-fav-button"> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Add to Favourite"><i class="fa fa-star"></i></a> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Notification"><i class="fa fa-bell"></i></a>
                                    <!-- AddToAny BEGIN -->
                                    <a class="a2a_dd" href="https://www.addtoany.com/share#url=https%3A%2F%2Fcompanydemo.in%2Fdemos%2FVariStats%2FLayout2-v3%2Findex.html&amp;title=Varistats" data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-share-alt"></i></a>
                                    <script>
                ...
                <div class="col-md-4 col-lg-4 col-6 aos-init" data-aos="fade-up" data-aos-delay="300">
                    <div class="covid-widget-1">
                        <div class="icon"> <img src="./assets/images/books.png" alt=""> </div>
                        <div class="info">
                            <h5>Finance</h5>
                            <ul class="infoImgArea">
                                <li> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html"> <img src="./assets/images/infographic3.jpg"></a> </li>
                                <div class="info-fav-button"> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Add to Favourite"><i class="fa fa-star"></i></a> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Notification"><i class="fa fa-bell"></i></a>
                                    <!-- AddToAny BEGIN -->
                                    <a class="a2a_dd" href="https://www.addtoany.com/share#url=https%3A%2F%2Fcompanydemo.in%2Fdemos%2FVariStats%2FLayout2-v3%2Findex.html&amp;title=Varistats" data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-share-alt"></i></a>
                                    <script>
                ...
                <div class="col-md-4 col-lg-4 col-6 aos-init" data-aos="fade-up" data-aos-delay="400">
                    <div class="covid-widget-1">
                        <div class="icon"> <img src="./assets/images/agriculture.png" alt=""> </div>
                        <div class="info">
                            <h5>Education</h5>
                            <ul class="infoImgArea">
                                <li> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html"> <img src="./assets/images/infographic4.jpg"></a> </li>
                                <div class="info-fav-button"> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Add to Favourite"><i class="fa fa-star"></i></a> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Notification"><i class="fa fa-bell"></i></a>
                                    <!-- AddToAny BEGIN -->
                                    <a class="a2a_dd" href="https://www.addtoany.com/share#url=https%3A%2F%2Fcompanydemo.in%2Fdemos%2FVariStats%2FLayout2-v3%2Findex.html&amp;title=Varistats" data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-share-alt"></i></a>
                                    <script>
                ...
                <div class="col-md-4 col-lg-4 col-6 aos-init" data-aos="fade-up" data-aos-delay="500">
                    <div class="covid-widget-1">
                        <div class="icon"> <img src="./assets/images/skills.png" alt=""> </div>
                        <div class="info">
                            <h5>Economy</h5>
                            <ul class="infoImgArea">
                                <li> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html"> <img src="./assets/images/infographic8.jpg"></a> </li>
                                <div class="info-fav-button"> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Add to Favourite"><i class="fa fa-star"></i></a> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Notification"><i class="fa fa-bell"></i></a>
                                    <!-- AddToAny BEGIN -->
                                    <a class="a2a_dd" href="https://www.addtoany.com/share#url=https%3A%2F%2Fcompanydemo.in%2Fdemos%2FVariStats%2FLayout2-v3%2Findex.html&amp;title=Varistats" data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-share-alt"></i></a>
                                    <script>
                ...
                <div class="col-md-4 col-lg-4 col-6 aos-init" data-aos="fade-up" data-aos-delay="600">
                    <div class="covid-widget-1">
                        <div class="icon"> <img src="./assets/images/infrastructure.png" alt=""> </div>
                        <div class="info">
                            <h5>Aqua Industry</h5>
                            <ul class="infoImgArea">
                                <li> <a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html"> <img src="./assets/images/infographic9.jpg"></a> </li>
                                <div class="info-fav-button"> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Add to Favourite"><i class="fa fa-star"></i></a> <a href="javascript:void;" data-toggle="tooltip" data-placement="top" title="Notification"><i class="fa fa-bell"></i></a>
                                    <!-- AddToAny BEGIN -->
                                    <a class="a2a_dd" href="https://www.addtoany.com/share#url=https%3A%2F%2Fcompanydemo.in%2Fdemos%2FVariStats%2FLayout2-v3%2Findex.html&amp;title=Varistats" data-toggle="tooltip" data-placement="top" title="Share"><i class="fa fa-share-alt"></i></a>
                                    <script>
...
<div class="RequestDataArea aos-init" data-aos="fade-up" data-aos-delay="500">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-center"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="btn btn-primary">Request Data</a></div>
        </div>
        <hr>
        <div class="row mt-4 mb-4 align-items-center">
            <div class="col-md-4 text-center"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="btn btn-primary">Submit Data</a></div>
        ...
        <div class="row mt-4 align-items-center">
            ...
            <div class="col-md-4 text-center"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="btn btn-primary">Read More</a></div>
        </div>
    </div>
</div>
<!--./RequestDataArea-->
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="100">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/login.html" class="submit_btn round-btn" data-toggle="tooltip" data-placement="top" title="Please Login"><img src="./assets/images/ico-lock.png"></a></div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="200">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/statistics.html" class="submit_btn">Explore</a></div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="500">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/infographics.html" class="submit_btn">Explore</a></div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="600">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/data-store.html" class="submit_btn">Get More</a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-3 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="100">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="submit_btn btn-yellow font-13 mt-0">Register</a></div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="200">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="submit_btn btn-yellow font-13 mt-0">Subscribe</a></div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="300">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="submit_btn btn-yellow font-13 mt-0">Subscribe <sup>*</sup></a></div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="400">
                <div class="have-symptom-content">
                    ...
                    <div class="btntext"><a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="submit_btn btn-yellow font-13 mt-0">Get a Quote</a></div>
                </div>
            </div>
        </div>
        <small class="text-right float-right mt-2">* All products require an annual contract.</small>
        <div class="clearfix"></div>
        <a href="https://companydemo.in/demos/VariStats/Layout2-v3/index.html#" class="price-overview-btn">Go to Pricing
            Overview</a>
    </div>
</div>
...
<div class="section-padding pt-3 pb-3">
    <div class="container">
        ...
        <div class="row numbers-counting aos-init" data-aos="fade-left" data-aos-delay="600">
            ...
            <div class="col">
                <h3><span class="counter-value" data-count="50000">50000</span>+</h3>
                <p>Corporates</p>
            </div>
        </div>
    </div>
