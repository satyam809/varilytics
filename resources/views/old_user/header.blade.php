                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand" href="index"> <img src="{{ url('assets/images/logo.jpeg') }}" alt="" class="img-fluid" style="width:80px;"> </a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="{{ url('data_atlas')}}">Data Atlas </a> <span class="toggle-dropdown"></span>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="{{ url('registration') }}">Registration</a> <a class="dropdown-item" href="{{ url('purchase') }}">Purchase</a>
                                                <ul>
                                                    <li class="dropdown-toggle2"> <a class="dropdown-item" href="{{ url('subscription') }}" data-toggle="dropdown">Subscription
                                                        </a>
