...
<div class="prevention section-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="rigPanelBox">
                    <h2 class="mb-0"><i class="fa fa-search"></i> World - Maize - Production (Million tonnes)</h2>
                    <div class="table-padding multiselect2">
                        ...
                        <div class="d-flex">
                            ...
                            <button type="submit" class="submit_btn mr-2 mt-4" style="height:40px;line-height: normal;">Run Query</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="rigPanelBox">
                    <h2><i class="fa fa-bar-chart-o"></i> World - Maize - Production (Million tonnes)
                        <div class="dropdown chartMenuArea"> <i class="fa fa-bar-chart" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <input type="radio" name="mychart" class="mychart" id="line" value="line" onclick="chartfunc()">
                                    Line
                                </li>
                            </ul>
                        </div>
                        <i class="fa fa-arrows-alt btn-fullscreen" aria-hidden="true"></i> <i class="fa fa-print printIconArea" aria-hidden="true"></i> <i class="fa fa-download DownloadIconArea" aria-hidden="true"></i>
                    </h2>
                    <div id="Household_Type_Survey_Status" style="min-width: 110px; height: 500px; margin: 0 auto"></div>
                </div>
            </div>
            <!--./left Box-->
            <!--right Box-->
            <div class="col-md-6">
                <div class="rigPanelBox">
                    <h2 class="mb-0"><i class="fa fa-table"></i> World - Maize - Production (Million tonnes) <i class="fa fa-arrows-alt btn-fullscreen" aria-hidden="true"></i> <i class="fa fa-print printIconArea" aria-hidden="true" style="right: 35px;"></i> <i class="fa fa-download DownloadIconArea" aria-hidden="true" style="right: 65px;"></i> </h2>
                    <div class="table-padding">
                        <table class="table table-hover responsive dataTable stripe" style="width:100%">
                            <thead>
                                <tr>
                                    <th class="text-left">Season</th>
                                    <th class="text-right">VariLytics</th>
                                    <th class="text-right">FAO</th>
                                    <th class="text-right">ICAR</th>
                                    <th class="text-right">NSSO</th>
                                </tr>
                                <tr>
                                    <td class="text-left">Last Update</td>
                                    <td class=" text-right">8 Jul 2021</td>
                                    <td class=" text-right">8 Jul 2021</td>
                                    <td class=" text-right">20 Jan 2021</td>
                                    <td class=" text-right">20 Jan 2021</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class=" text-left">2020/21</td>
                                    <td class=" text-right">1,156.33</td>
                                    <td class=" text-right">1,476.55</td>
                                    <td class=" text-right">1.29</td>
                                    <td class=" text-right">1.29</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2019/20</td>
                                    <td class=" text-right">1,139.31</td>
                                    <td class=" text-right">279.04</td>
                                    <td class=" text-right">-7.42</td>
                                    <td class=" text-right">7.12</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2018/19</td>
                                    <td class=" text-right">1,116.59</td>
                                    <td class=" text-right">1,197.50</td>
                                    <td class=" text-right">3.56</td>
                                    <td class=" text-right">8.56</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2017/18</td>
                                    <td class=" text-right">1,135.52</td>
                                    <td class=" text-right">1,192.66</td>
                                    <td class=" text-right">1.42</td>
                                    <td class=" text-right">4.42</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2016/17</td>
                                    <td class=" text-right">1,096.11</td>
                                    <td class=" text-right">142.74</td>
                                    <td class=" text-right">144.45</td>
                                    <td class=" text-right">244.45</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2015/16</td>
                                    <td class=" text-right">1,052.45</td>
                                    <td class=" text-right">708.56</td>
                                    <td class=" text-right">1.52</td>
                                    <td class=" text-right">144.45</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2014/15</td>
                                    <td class=" text-right">335.25</td>
                                    <td class=" text-right">339.65</td>
                                    <td class=" text-right">1.31</td>
                                    <td class=" text-right">144.45</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2013/14</td>
                                    <td class=" text-right">173.70</td>
                                    <td class=" text-right">188.01</td>
                                    <td class=" text-right">188.77</td>
                                    <td class=" text-right">144.45</td>
                                </tr>
                                <tr>
                                    <td class=" text-left">2012/13</td>
                                    <td class=" text-right">301.40</td>
                                    <td class=" text-right">279.04</td>
                                    <td class=" text-right">292.67</td>
                                    <td class=" text-right">344.45</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
