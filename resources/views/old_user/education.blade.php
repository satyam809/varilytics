                                ...
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="statistics">Statistics </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="agriculture">Agriculture </a> <a class="dropdown-item" href="art-design">Art and Design</a> <a class="dropdown-item" href="education">Education </a> <a class="dropdown-item" href="finance">Finance </a> </div>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="data_atlas">Data Atlas </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="data-board">Data Board </a> <a class="dropdown-item" href="data_coverage">Data Coverage </a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown">Tools </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="simple_search">Search</a> <a class="dropdown-item" href="custom-query">Query</a> <a class="dropdown-item" href="compare_sources">Compare</a> <a class="dropdown-item" href="create">Create</a> <a class="dropdown-item" href="publish">Publish</a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="resources">Resources </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item disabled" href="compendiums">Compendiums</a> <a class="dropdown-item disabled" href="repositories">Repositories</a> <a class="dropdown-item disabled" href="intelligence_system">Intelligence System</a> <a class="dropdown-item" href="newsfeed">Newsfeed</a> <a class="dropdown-item" href="blogs">Blogs</a> </div>
                                        </li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col" data-aos="fade-up" data-aos-delay="600">
                        <p class="font-20">Education statistics tell us the facts and figures. They can shape or inspire your actions. They can tell what needs to be done where and how</p>
                    </div>
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="600"> <img src="assets/images/blank.png" class="w-100 mb-3 float-right"> </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="font-20">Find India-centric education related data at one place. We also cover other countries that are related to India economically or socially in context to Indian education. </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-3" data-aos="fade-up" data-aos-delay="100">We follow an open data policy. All Statistics provided has their source acknowledged and declared.</div>
                        <div class="mb-3" data-aos="fade-up" data-aos-delay="100">Statistics we source from public domains is provided free with auto charting tools.</div>
                        <div class="mb-3" data-aos="fade-up" data-aos-delay="100">
                            <button class="btn btn-primary">Register</button>
                            to access free basic statistics.
                        </div>
                        <div class="mb-3" data-aos="fade-up" data-aos-delay="100">We Provided Data tools to extract and analyze the data. We also provide our own analysis on the open data to provide crisp relevant and insightful statistics.</div>
                        <div class="mb-3" data-aos="fade-up" data-aos-delay="100">
                            <button class="btn btn-primary">Subscribe</button>
                            to access premium statistics.
                        </div>
                        <div class="mb-5" data-aos="fade-up" data-aos-delay="100">You can
                            <button class="btn btn-primary">Subscribe</button>
                            for customized statistics data.
                        </div>
                        <div class="popular-statistics section-padding pt-0">
                            <div class="section-title text-center mb-0">
                        ...
                        <div class="mb-4" data-aos="fade-up" data-aos-delay="100">Still don’t see what you want,
                            <button class="btn btn-primary">Submit Data Request</button>
                        </div>
                        <div class="mb-0" data-aos="fade-up" data-aos-delay="100">We shall get back to you shortly getting the data you require</div>
                    </div>
                </div>
            </div>
        </div>
