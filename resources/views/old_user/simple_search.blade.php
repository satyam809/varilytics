...
<style type="text/css">
    .dataTables_wrapper .nice-select,
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand" href="index"> <img src="assets/images/logo.png" alt="" class="img-fluid"> </a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="insights">Insights </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="infographics">Infographics </a> <a class="dropdown-item" href="visuals">Visuals </a> <a class="dropdown-item" href="analytics">Analytics</a> <a class="dropdown-item" href="dashboards">Dashboards </a> <a class="dropdown-item" href="on_demand_services">On Demand Services </a> </div>
                                        </li>
                                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="data_atlas">Data Atlas </a> <span class="toggle-dropdown"></span>
                                            <div class="dropdown-menu"> <a class="dropdown-item" href="data_board">Data Board </a> <a class="dropdown-item" href="data_coverage">Data Coverage </a> </div>
                                        </li>
