            ...
            <div class="form-items" style="margin:auto">
                ...
                <form method="post" action="userLoginSubmit">
                    ...
                    <div class="form-button">
                        ...
                        <a href="forget_password" class="switcher-text2 inline-text">Forgot password?</a>
                    </div>
                    <span style="color:red;">{{ session('error') }}</span>
                </form>
                <hr>
                <p class="footer-loginForm">Don't have an Account? <a href="registration" class="switcher-text2 inline-text">Register</a></p>
            </div>
