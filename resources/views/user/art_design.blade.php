    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="600" style="font-size: 18px;">
                <p>Art & Design statistics can tell us the facts and figures of how important art and design are and will be in human lives. Art has lived through civilizations providing the backdrop of progress and expression of human creativity</p>
                <p>Find India-centric art and design related data at one place. We also cover other countries that are related to India economically or culturally or socially in context to Indian art and design.</p>
                <p>VariLytics brings curated, collated, processed, and analyzed statistics for you</p>
            </div>
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="600"> <img src="{{ asset('assets/images/artdesign.jpg')}}" class="w-100 mb-3 float-right"> </div>
        </div>
