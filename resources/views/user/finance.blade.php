        ...
        <div class="data-times white-bg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8" data-aos="fade-up" data-aos-delay="600" style="font-size: 18px;">
                        <p>Finance statistics tell us the facts and figures. They can help set your action and directions. Our statistics can bring finance data discovery at one point from the myriad of sources possible compressing the data analysis and intelligence for your better work output.</p>
                        <p>Find India-centric education related data at one place. We also cover other countries that are related to India economically or socially in context to Indian education. </p>
                        <p>VariLytics brings curated, collated, processed, and analyzed statistics for you.</p>
                        <p>We also provide customized solutions for primary data collection for insightful statistics.</p>
                        <p>Our tools allow you to visualize statistics with your own data sets through compare tools. You can upload your estimates and see them plotted with the database statistics. </p>
                    </div>
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="600"> <img src="{{ asset('assets/images/finance.jpg')}}" class="w-100 mb-3 float-right" style="height:55vh"> </div>
                </div>
                <div class="row">
                    <div class="col">
