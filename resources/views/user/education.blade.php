            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8" data-aos="fade-up" data-aos-delay="600" style="font-size: 18px;">
                        <p>Education statistics tell us the facts and figures. They can shape or inspire your actions. They can tell what needs to be done where and how</p>
                    ...
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="600"> <img src="{{ asset('assets/images/education1.jpg')}}" class="w-100 mb-3 float-right" style="height:54vh;"> </div>
                </div>
